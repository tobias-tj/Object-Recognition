...
class Frut extends StatefulWidget {
  const Frut({super.key});

  @override
  State<Frut> createState() => _FrutState();
}

class _FrutState extends State<Frut> {
  bool _loading = true;
  late File _image;
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: 'assets/frut_model/model_unquant.tflite',
        labels: 'assets/frut_model/labels.txt');
  }
            ...
            Center(
              child: _loading
                ? Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/fruts-icons.png'),
                      const SizedBox(
                        height: 50,
                      )
                    ],
